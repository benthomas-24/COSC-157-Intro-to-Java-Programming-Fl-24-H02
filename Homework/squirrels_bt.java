...
public class squirrels_bt {
    public static void main(String[] args) {
        ...
        numberOfNuts = (numberOfNuts) - (numberOfNutsForSquirrel2+1);
        int numberOfNutsForSquirrel3 = (numberOfNuts/ 5);
        numberOfNuts = (numberOfNuts) - (numberOfNutsForSquirrel3+1);
        int numberOfNutsForSquirrel4 = (numberOfNuts/ 5);
        numberOfNuts = (numberOfNuts) - (numberOfNutsForSquirrel4+1);
        int numberOfNutsForSquirrel5 = (numberOfNuts/ 5) ;
        numberOfNuts = (numberOfNuts) - (numberOfNutsForSquirrel5+1);
        int numberOfNutsInTheMorning = initialNumberOfNuts - numberOfNuts;
        ...
        System.out.printf("The number of nuts that the chipmunk got during the night: %d%n", 1);
        System.out.printf("The number of nuts in the pile in the morning: %d%n", numberOfNutsInTheMorning);
        System.out.printf("The number of nuts each squirrel got in the morning: %d%n",numberOfNutsInTheMorning/5);
        System.out.printf("number of nuts the chipmunk got in the morning: %d%n", numberOfNutsInTheMorning%5);
        input.close();
    } // main method
